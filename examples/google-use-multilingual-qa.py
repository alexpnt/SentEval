...
g = tf.Graph()
with g.as_default():
    module = hub.Module('../data/models/use-multilingual-qa/c9711495577380fafeb2039075fe8a528fe62743/')  # load tfhub module
    question = tf.placeholder(dtype=tf.string, shape=[None])  # question
    question_encoder = module(question, signature="question_encoder", as_dict=True)
