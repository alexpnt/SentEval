...
def batcher(params, batch):
    ...
    for sent in batch:
        ...
        with torch.no_grad():
            hidden_states, mem = params['transformer-xl'](tokens_tensor)
...
params_senteval['tokenizer'] = TransfoXLTokenizer.from_pretrained('transfo-xl-wt103')
params_senteval['transformer-xl'] = TransfoXLModel.from_pretrained('transfo-xl-wt103')
params_senteval['transformer-xl'].eval()
